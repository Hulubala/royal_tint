...
import 'package:royal_tint/data/repositories/manager_repository.dart';
...
class InitialSetupService {
  ...
  Future<Map<String, dynamic>> runCompleteSetup({
    ...
    try {
      ...
      await _branchRepository.setupDefaultBranches();
  ...
  Future<Map<String, dynamic>> getSetupInfo() async {
    try {
      ...
      List<Map<String, dynamic>> branches = await _branchRepository.getAllBranches();
      List<Map<String, dynamic>> managers = await _managerRepository.getAllManagers();
