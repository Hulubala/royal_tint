...
class ShopInfoPanel extends StatefulWidget {
  const ShopInfoPanel({super.key});

  @override
  State<ShopInfoPanel> createState() => _ShopInfoPanelState();
}

class _ShopInfoPanelState extends State<ShopInfoPanel> {
